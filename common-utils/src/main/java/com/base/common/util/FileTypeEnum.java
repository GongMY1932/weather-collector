...
public enum FileTypeEnum {
    ...
    public static String getTypeBySuffix(String suffix) {
        for (FileTypeEnum fileTypeEnum : FileTypeEnum.values()) {
            if (fileTypeEnum.suffix.equals(suffix)) {
    ...
    public static String getTypeBySuffix(String suffix, String charset) {
        String type = getTypeBySuffix(suffix);
